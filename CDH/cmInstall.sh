...
sudo unzip /opt/sofware/mysql/mysql-connector-java-5.1.48.zip -d /opt/software
...
# 拷贝下载文件
cp /opt/software/cm/CDH-5.16.2-1.cdh5.16.2.p0.8-el6.parcel /opt/cloudera/parcel-repo/
cp /opt/software/cm/CDH-5.16.2-1.cdh5.16.2.p0.8-el6.parcel.sha1 /opt/cloudera/parcel-repo/CDH-5.16.2-1.cdh5.16.2.p0.8-el6.parcel.sha
